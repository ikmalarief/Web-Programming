					...
					<div class="container">
						...
						<div class="collapse navbar-collapse" id="navbarNav">
							<ul class="navbar-nav ms-auto ">
								...
								<li class="nav-item navi"><a class="nav-link text-white" href="logout.php">Logout</a>
								</li>
				...
				<div class="container text-white text-center hero " style="z-index: 2;">
					<div class="row">
						<div class="col-12">
							...
							<p class="my-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius, laudantium
								repellendus accusantium culpa eligendi cum praesentium quae ipsam explicabo doloremque
								cupiditate esse, ratione error deleniti assumenda fugiat debitis corrupti. Consectetur.</p>
